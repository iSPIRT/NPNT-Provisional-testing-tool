...
def generate_all_test_permission_artefacts(drone_id, drone_pub_key):
...
def generate_valid_permission(drone_id, drone_pub_key):
...
def generate_bad_sign_artefact(drone_id, drone_pub_key):
    coords = [[77.609316, 12.934158], [77.609852, 12.934796],
              [77.610646, 12.934183], [77.610100, 12.933551], [77.609316,
                                                               12.934158]]  # placeholder , replace the coordinates with the correct one
    permission = createArtifact(drone_id, FLIGHT_PURPOSE, PAYLOAD_WEIGHT,
...
def generate_bad_geo_artefact(drone_id, drone_pub_key):
...
def generate_bad_time_artefact(drone_id, drone_pub_key):
...
def generate_bad_pin_artefact(drone_id, drone_pub_key):
